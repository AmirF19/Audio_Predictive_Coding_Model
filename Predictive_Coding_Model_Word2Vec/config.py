"""
Configuration for the Predictive Coding N400 Model (Word2Vec version)
"""
...
OUTPUT_DIR = PROJECT_ROOT / "Predictive_Coding_Model_Word2Vec" / "results"
...
WORD2VEC_DIM = 300  # Standard Word2Vec dimension
